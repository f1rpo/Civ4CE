...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("isFriendlyCity", &CyPlot::isFriendlyCity, "bool (int /*TeamTypes eTeam*/)")
		.def("isEnemyCity", &CyPlot::isEnemyCity, "bool (int /*TeamTypes eTeam*/)")
		...
		.def("isVisibleEnemyDefender", &CyPlot::isVisibleEnemyDefender, "bool (int /*PlayerTypes*/ ePlayer)")
		.def("getNumDefenders", &CyPlot::getNumDefenders, "int (int /*PlayerTypes*/ ePlayer)")
		.def("getNumVisibleEnemyDefenders", &CyPlot::getNumVisibleEnemyDefenders, "int (int /*PlayerTypes*/ ePlayer)")
		.def("getNumVisiblePotentialEnemyDefenders", &CyPlot::getNumVisiblePotentialEnemyDefenders, "int (int /*PlayerTypes*/ ePlayer)")
		...
		.def("isTradeNetworkImpassable", &CyPlot::isTradeNetworkImpassable, "bool ()")
		...
		.def("isValidDomainForLocation", &CyPlot::isValidDomainForLocation, "bool (DomainTypes eDomain)")
		.def("isValidDomainForAction", &CyPlot::isValidDomainForAction, "bool (DomainTypes eDomain)")
