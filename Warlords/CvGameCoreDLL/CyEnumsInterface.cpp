...
void CyEnumsPythonInterface()
{
	...
	python::enum_<PlotLandscapeLayers>("PlotLandscapeLayers")
		...
		.value("PLOT_LANDSCAPE_LAYER_HIGHLIGHT_PLOTS", PLOT_LANDSCAPE_LAYER_HIGHLIGHT_PLOTS)
	...
	python::enum_<EngineDirtyBits>("EngineDirtyBits")
		...
		.value("FogOfWar_DIRTY_BIT", FogOfWar_DIRTY_BIT)
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_LIGHT_DEBUG_SPINNER", WIDGET_LIGHT_DEBUG_SPINNER)
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_DIPLOVOTE_RESULTS", BUTTONPOPUP_DIPLOVOTE_RESULTS)
	...
	python::enum_<FogOfWarModeTypes>("FogOfWarModeTypes")
		...
		.value("FOGOFWARMODE_EXPLORED", FOGOFWARMODE_EXPLORED)
	...
	python::enum_<EntityEventTypes>("EntityEventTypes")
		.value( "ENTEVENT_NONE", ENTEVENT_NONE )
		;
	...
	python::enum_<AnimationPathTypes>("AnimationPathTypes")
		...
		.value( "ANIMATIONPATH_DIE", ANIMATIONPATH_DIE )
		.value( "ANIMATIONPATH_MELEE_BEGIN", ANIMATIONPATH_MELEE_BEGIN )
		...
		.value( "ANIMATIONPATH_MELEE_END", ANIMATIONPATH_MELEE_END )
		.value( "ANIMATIONPATH_RANGED_BEGIN", ANIMATIONPATH_RANGED_BEGIN )
		.value( "ANIMATIONPATH_RANGED_STRIKE", ANIMATIONPATH_RANGED_STRIKE )
		.value( "ANIMATIONPATH_RANGED_HURT", ANIMATIONPATH_RANGED_HURT )
		...
		.value( "ANIMATIONPATH_RANGED_END", ANIMATIONPATH_RANGED_END )
