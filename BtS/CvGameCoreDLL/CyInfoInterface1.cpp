...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		.def("getSeeInvisibleType", &CvUnitInfo::getSeeInvisibleType, "int ()")
		...
		.def("getReligionSpreads", &CvUnitInfo::getReligionSpreads, "bool (int i)")
		...
		.def("getEarlyArtDefineTag", &CvUnitInfo::getEarlyArtDefineTag, "string (int i)")
		.def("getLateArtDefineTag", &CvUnitInfo::getLateArtDefineTag, "string (int i)")
		.def("getMiddleArtDefineTag", &CvUnitInfo::getMiddleArtDefineTag, "string (int i)")
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		.def("isDiploVote", &CvBuildingInfo::isDiploVote, "bool ()")
