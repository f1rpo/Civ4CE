...
//		.def("isCityNameValid", &CyPlayer::isCityNameValid, "bool (wstring szName, bool bTestDestroyed)")
		...
		.def("foundReligion", &CyPlayer::foundReligion, "void (int /*ReligionTypes*/ eReligion)")
		...
		.def("setGold", &CyPlayer::setGold, "void ()")
		.def("changeGold", &CyPlayer::changeGold, "void ()")
		...
		.def("isLateEra", &CyPlayer::isLateEra, "bool ()")
