...
void CyGamePythonInterface()
{
	...
	python::class_<CyGame>("CyGame")
		...
		.def("isTeamVoteEligible", &CyGame::isTeamVoteEligible, "bool (int eTeam)")
		.def("countVote", &CyGame::countVote, "int (int eVote, int iChoice)")
		.def("countPossibleVote", &CyGame::countPossibleVote, "int ()")
		.def("findHighestVoteTeam", &CyGame::findHighestVoteTeam, "int (int eVote)")
		.def("getVoteRequired", &CyGame::getVoteRequired, "int (int eVote)")
		.def("getSecretaryGeneral", &CyGame::getSecretaryGeneral, "int ()")
		...
		.def("isDiploVote", &CyGame::isDiploVote, "bool ()")
		.def("makeDiploVote", &CyGame::makeDiploVote)
		...
		.def("isVoteTriggered", &CyGame::isVoteTriggered)
