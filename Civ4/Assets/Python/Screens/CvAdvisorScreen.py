...
class CvAdvisorScreen(CvGFCScreen.CvGFCScreen):
	...
	def interfaceScreen(self):
		...
		screen.addPanel( self.advisorTextPanelWidget, u"", u"", False, False, self.X_SCREEN + self.W_LEADERHEAD, self.Y_SCREEN + 32, self.W_SCREEN - ( self.W_LEADERHEAD + 200 ), self.H_LEADERHEAD - 86, PanelStyles.PANEL_STYLE_BLUELARGE)
		screen.addPanel( "AdvisorButtonPanel", u"", u"", False, False, self.X_SCREEN + self.W_LEADERHEAD, self.Y_SCREEN + 152, self.W_SCREEN - ( self.W_LEADERHEAD + 200 ), 53, PanelStyles.PANEL_STYLE_BLUELARGE)
...
#						self.W_DEBUG_TEXT,self.W_DEBUG_TEXT)
	...
	def setLeaderheadAdvisor(self, advisor):
		self.getScreen().setLeaderheadAdvisor(self.LEADER_WIDGET, advisor)
